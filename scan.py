...
def main():
    os.system('clear')
    print("{}        ____ ").format(r)
    print("   _WELCOME ABONASR TOOL SCAN")
    print("  TLEGRAM : https://t.me/B4_4444")
    print("  ANONY")
    print("{} WITH ABONASR.SY").format(w)
    print("  |CS   '--'     | ")
    print("{}  '--------------'----------{}------------------.  ").format(r,w)
    print("{}  | {}Author  : {}HVmbl3 {}     | {}INDO{}N{}{}ESIA         | ").format(r,w,r,w,r,ir,reset,w)
    print("{}  | {}Youtube : {}Shodiq 2701 {}| {}+249129005197 {}|").format(r,w,w,w,lgray,w)
    print("{}  '------------------------------------{}-------'  ").format(r,w)
